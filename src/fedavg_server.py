...
class FedAvgServer(object):
    ...
    def start_server(self):
        ...
        while self.epoch < self.args.epochs:
            ...
            model_updated = self._apply_server_update(copy.deepcopy(global_model), copy.deepcopy(global_deltas))
            global_model.load_state_dict(model_updated)

            # Test global model inference on validation set after each round
