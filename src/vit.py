...
Implementation from https://github.com/tintn/vision-transformer-from-scratch/blob/main/vit.py
Description at https://towardsdatascience.com/implementing-vision-transformer-vit-from-scratch-3e192c6155f0
...
class Embeddings(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.position_embeddings = \
            nn.Parameter(torch.randn(1, self.patch_embeddings.num_patches + 1, args.hidden_size))
...
class Block(nn.Module):
    """
    Combine multi-head attention and MLP to create a single transformer block.
    """

    def __init__(self, args):
        super().__init__()
        self.use_faster_attention = args.use_faster_attention
...
class Encoder(nn.Module):
    """
    The transformer encoder module. Stacks multiple transformer layers sequentially
    """
